    ...
    <nav className="bg-[#FFFBE5] relative top-0 left-0 w-full z-50">
      <div className="container mx-auto flex items-center justify-between py-4 px-6">
        ...
        <Link href="/contact" onClick={handleLinkClick}>
          <span className="hidden md:block border border-green-600 text-green-700 px-10 py-2 rounded-md hover:bg-green-100 transition lg:ml-22 md:ml-10 cursor-pointer">
            Contact Us
          </span>
        </Link>
      ...
      {/* Mobile Dropdown */}
      {menuOpen && (
        <div className="md:hidden bg-[#FFFBE5] shadow-lg absolute top-16 left-0 w-full py-4 px-6 z-40">
